      ...
      <el-col :span="12">
        <el-card class="box-card" shadow="never" style="height: 300px">
          ...
          <div class="media align-items-center border">
            <span class="py-5 px-4 bg-light border-right">昨日销量</span>
            <div class="media-body">
              <div class="border-bottom pl-3 pb-3 mb-3">
                <span>订单金额(元)  </span>12
              </div>
              <div class="pl-3">
                <span>订单量(件) </span>12
          ...
          <div class="media align-items-center border mt-3">
            <span class="py-5 px-4 bg-light border-right">本月销量</span>
            <div class="media-body">
              <div class="border-bottom pl-3 pb-3 mb-3">
                <span>订单金额(元)  </span>12
              </div>
...
export default {
  ...
  data() {
    return {
      counts: [
        {icon: 'el-icon-user-solid', color: 'bg-primary', num: 30, desc: '关注人数(个)'},
